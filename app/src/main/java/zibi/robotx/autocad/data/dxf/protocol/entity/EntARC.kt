...
class EntARC(lastElem: DxfChain, isRead: Boolean) : EntCommon() {
	...
	public fun checkInterpolate(): List<Vector3f>?{
		if( interpolatePoints == null )
			interpolatePoints = interpolateArc(CenterPoint, Radius, ExtrusionDirection, StartAngle, EndAngle )
	...
	//	100	
	const val AcDbArc: String = "AcDbArc"
	 }
