...
class EntSOLID(lastElem: DxfChain, isRead: Boolean) : EntCommon() {



	//	 First corner, DXF: X value APP: 3D pointDXF: Y and Z values of first corner
	//	10	20	30	
	var FirstCorner: Vector3f? = null

	//	 Second corner, DXF: X value APP: 3D pointDXF: Y and Z values of second corner
	//	11	21	31	
	var SecondCorner: Vector3f? = null

	//	 Third corner, XF: X value APP: 3D pointDXF: Y and Z values of third corner
	//	12	22	32	
	var ThirdCorner: Vector3f? = null

	//	 Fourth corner. If only three corners are entered to define the SOLID, then the fourth corner coordinate is the same as the third., DXF: X value APP: 3D pointDXF: Y and Z values of fourth corner
	//	13	23	33	
